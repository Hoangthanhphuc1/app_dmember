            ...
            return (
                ...
                <View style={styles.borderTopProduct}>
                    <View>
                        ...
                        <Image style={{  width: WidthScreen * 0.072, height: screenHeight * 0.039, position: "absolute", left: 110, top: 10 }}
                         resizeMode="contain" source={item.tag} />
                    </View>
                    ...
                    <View style={styles.priceanddiscount}>
                        ...
                        <TouchableOpacity>
                        <Image style={{ width: WidthScreen * 0.072, height: screenHeight * 0.034 }}
                         resizeMode="contain" source={require('../Assets/addbtn.png')} />
                        </TouchableOpacity>
                    </View>
                </View>
                </TouchableOpacity>
                    ...
                    {/* <View style={styles.ViewBorderPro}> */}
                        <View style={styles.borderPro}>
                            <View>
                                ...
                                <Image style={{ width: WidthScreen * 0.072, height: screenHeight * 0.039, position: "absolute", left: 95, top: -1 }} 
                                 resizeMode="contain" source={item.tag} />
                            </View>
                            ...
                            <View style={{flexDirection: "row", justifyContent: 'space-between', alignItems: "center"}}>
                                <View style={{ flexDirection: "column", }}>
                                    ...
                                    <View style={styles.priceanddiscount2}>
                                        ...
                                        <Text style={styles.disnum}>{item.dis}</Text>
                                        <TouchableOpacity>
                                        <Image style={{ width: WidthScreen * 0.072, height: screenHeight * 0.034, marginLeft:13 }}
                                         resizeMode="contain" source={require('../Assets/addbtn.png')} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
